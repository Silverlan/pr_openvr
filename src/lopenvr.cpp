...
void Lua::openvr::register_lua_library(Lua::Interface &l)
{
	...
	std::unordered_map<std::string, lua_Integer> propErrorEnums {{"TRACKED_PROPERTY_ERROR_SUCCESS", static_cast<int32_t>(vr::ETrackedPropertyError::TrackedProp_Success)}, {"TRACKED_PROPERTY_ERROR_WRONG_DATA_TYPE", static_cast<int32_t>(vr::ETrackedPropertyError::TrackedProp_WrongDataType)},
	  {"TRACKED_PROPERTY_ERROR_WRONG_DEVICE_CLASS", static_cast<int32_t>(vr::ETrackedPropertyError::TrackedProp_WrongDeviceClass)}, {"TRACKED_PROPERTY_ERROR_BUFFER_TOO_SMALL", static_cast<int32_t>(vr::ETrackedPropertyError::TrackedProp_BufferTooSmall)},
	  {"TRACKED_PROPERTY_ERROR_UNKNOWN_PROPERTY", static_cast<int32_t>(vr::ETrackedPropertyError::TrackedProp_UnknownProperty)}, {"TRACKED_PROPERTY_ERROR_INVALID_DEVICE", static_cast<int32_t>(vr::ETrackedPropertyError::TrackedProp_InvalidDevice)},
	  {"TRACKED_PROPERTY_ERROR_COULD_NOT_CONTACT_SERVER", static_cast<int32_t>(vr::ETrackedPropertyError::TrackedProp_CouldNotContactServer)}, {"TRACKED_PROPERTY_ERROR_VALUE_NOT_PROVIDED_BY_DEVICE", static_cast<int32_t>(vr::ETrackedPropertyError::TrackedProp_ValueNotProvidedByDevice)},
	  {"TRACKED_PROPERTY_ERROR_STRING_EXCEEDS_MAXIMUM_LENGTH", static_cast<int32_t>(vr::ETrackedPropertyError::TrackedProp_StringExceedsMaximumLength)}, {"TRACKED_PROPERTY_ERROR_NOT_YET_AVAILABLE", static_cast<int32_t>(vr::ETrackedPropertyError::TrackedProp_NotYetAvailable)}};
	Lua::RegisterLibraryEnums(lua, "openvr", propErrorEnums);

	std::unordered_map<std::string, lua_Integer> propTrackingResults {{"TRACKING_RESULT_UNINITIALIZED", umath::to_integral(vr::ETrackingResult::TrackingResult_Uninitialized)},
	  {"TRACKING_RESULT_CALIBRATING_IN_PROGRESS", umath::to_integral(vr::ETrackingResult::TrackingResult_Calibrating_InProgress)}, {"TRACKING_RESULT_CALIBRATING_OUT_OF_RANGE", umath::to_integral(vr::ETrackingResult::TrackingResult_Calibrating_OutOfRange)},
	  {"TRACKING_RESULT_RUNNING_OK", umath::to_integral(vr::ETrackingResult::TrackingResult_Running_OK)}, {"TRACKING_RESULT_RUNNING_OUT_OF_RANGE", umath::to_integral(vr::ETrackingResult::TrackingResult_Running_OutOfRange)}};
	Lua::RegisterLibraryEnums(lua, "openvr", propTrackingResults);

	std::unordered_map<std::string, lua_Integer> trackedControllerRoles {{"TRACKED_CONTROLLER_ROLE_INVALID", umath::to_integral(vr::ETrackedControllerRole::TrackedControllerRole_Invalid)},
	  {"TRACKED_CONTROLLER_ROLE_LEFT_HAND", umath::to_integral(vr::ETrackedControllerRole::TrackedControllerRole_LeftHand)}, {"TRACKED_CONTROLLER_ROLE_RIGHT_HAND", umath::to_integral(vr::ETrackedControllerRole::TrackedControllerRole_RightHand)},
	  {"TRACKED_CONTROLLER_ROLE_OPT_OUT", umath::to_integral(vr::ETrackedControllerRole::TrackedControllerRole_OptOut)}, {"TRACKED_CONTROLLER_ROLE_TREADMILL", umath::to_integral(vr::ETrackedControllerRole::TrackedControllerRole_Treadmill)},
	  {"TRACKED_CONTROLLER_ROLE_STYLUS", umath::to_integral(vr::ETrackedControllerRole::TrackedControllerRole_Stylus)}, {"TRACKED_CONTROLLER_ROLE_MAX", umath::to_integral(vr::ETrackedControllerRole::TrackedControllerRole_Max)}};
	Lua::RegisterLibraryEnums(lua, "openvr", trackedControllerRoles);

	std::unordered_map<std::string, lua_Integer> initErrorEnums {{"INIT_ERROR_NONE", static_cast<int32_t>(vr::EVRInitError::VRInitError_None)}, {"INIT_ERROR_UNKNOWN", static_cast<int32_t>(vr::EVRInitError::VRInitError_Unknown)},

	  {"INIT_ERROR_INIT_INSTALLATION_NOT_FOUND", static_cast<int32_t>(vr::EVRInitError::VRInitError_Init_InstallationNotFound)}, {"INIT_ERROR_INIT_INSTALLATION_CORRUPT", static_cast<int32_t>(vr::EVRInitError::VRInitError_Init_InstallationCorrupt)},
	  {"INIT_ERROR_INIT_VR_CLIENT_DLL_NOT_FOUND", static_cast<int32_t>(vr::EVRInitError::VRInitError_Init_VRClientDLLNotFound)}, {"INIT_ERROR_INIT_FILE_NOT_FOUND", static_cast<int32_t>(vr::EVRInitError::VRInitError_Init_FileNotFound)},
	  {"INIT_ERROR_INIT_FACTORY_NOT_FOUND", static_cast<int32_t>(vr::EVRInitError::VRInitError_Init_FactoryNotFound)}, {"INIT_ERROR_INIT_INTERFACE_NOT_FOUND", static_cast<int32_t>(vr::EVRInitError::VRInitError_Init_InterfaceNotFound)},
	  {"INIT_ERROR_INIT_INVALID_INTERFACE", static_cast<int32_t>(vr::EVRInitError::VRInitError_Init_InvalidInterface)}, {"INIT_ERROR_INIT_USER_CONFIG_DIRECTORY_INVALID", static_cast<int32_t>(vr::EVRInitError::VRInitError_Init_UserConfigDirectoryInvalid)},
	  {"INIT_ERROR_INIT_HMD_NOT_FOUND", static_cast<int32_t>(vr::EVRInitError::VRInitError_Init_HmdNotFound)}, {"INIT_ERROR_INIT_NOT_INITIALIZED", static_cast<int32_t>(vr::EVRInitError::VRInitError_Init_NotInitialized)},
	  {"INIT_ERROR_INIT_PATH_REGISTRY_NOT_FOUND", static_cast<int32_t>(vr::EVRInitError::VRInitError_Init_PathRegistryNotFound)}, {"INIT_ERROR_INIT_NO_CONFIG_PATH", static_cast<int32_t>(vr::EVRInitError::VRInitError_Init_NoConfigPath)},
	  {"INIT_ERROR_INIT_NO_LOG_PATH", static_cast<int32_t>(vr::EVRInitError::VRInitError_Init_NoLogPath)}, {"INIT_ERROR_INIT_PATH_REGISTRY_NOT_WRITABLE", static_cast<int32_t>(vr::EVRInitError::VRInitError_Init_PathRegistryNotWritable)},
	  {"INIT_ERROR_INIT_APP_INFO_INIT_FAILED", static_cast<int32_t>(vr::EVRInitError::VRInitError_Init_AppInfoInitFailed)}, {"INIT_ERROR_INIT_RETRY", static_cast<int32_t>(vr::EVRInitError::VRInitError_Init_Retry)},
	  {"INIT_ERROR_INIT_CANCELED_BY_USER", static_cast<int32_t>(vr::EVRInitError::VRInitError_Init_InitCanceledByUser)}, {"INIT_ERROR_INIT_ANOTHER_APP_LAUNCHING", static_cast<int32_t>(vr::EVRInitError::VRInitError_Init_AnotherAppLaunching)},
	  {"INIT_ERROR_INIT_SETTINGS_INIT_FAILED", static_cast<int32_t>(vr::EVRInitError::VRInitError_Init_SettingsInitFailed)}, {"INIT_ERROR_INIT_SHUTTING_DOWN", static_cast<int32_t>(vr::EVRInitError::VRInitError_Init_ShuttingDown)},
	  {"INIT_ERROR_INIT_TOO_MANY_OBJECTS", static_cast<int32_t>(vr::EVRInitError::VRInitError_Init_TooManyObjects)}, {"INIT_ERROR_INIT_NO_SERVER_FOR_BACKGROUND_APP", static_cast<int32_t>(vr::EVRInitError::VRInitError_Init_NoServerForBackgroundApp)},
	  {"INIT_ERROR_INIT_NOT_SUPPORTED_WITH_COMPOSITOR", static_cast<int32_t>(vr::EVRInitError::VRInitError_Init_NotSupportedWithCompositor)}, {"INIT_ERROR_INIT_NOT_AVAILABLE_TO_UTILITY_APPS", static_cast<int32_t>(vr::EVRInitError::VRInitError_Init_NotAvailableToUtilityApps)},

	  {"INIT_ERROR_DRIVER_FAILED", static_cast<int32_t>(vr::EVRInitError::VRInitError_Driver_Failed)}, {"INIT_ERROR_DRIVER_UNKNOWN", static_cast<int32_t>(vr::EVRInitError::VRInitError_Driver_Unknown)},
	  {"INIT_ERROR_DRIVER_HMD_UNKNOWN", static_cast<int32_t>(vr::EVRInitError::VRInitError_Driver_HmdUnknown)}, {"INIT_ERROR_DRIVER_NOT_LOADED", static_cast<int32_t>(vr::EVRInitError::VRInitError_Driver_NotLoaded)},
	  {"INIT_ERROR_DRIVER_RUNTIME_OUT_OF_DATE", static_cast<int32_t>(vr::EVRInitError::VRInitError_Driver_RuntimeOutOfDate)}, {"INIT_ERROR_DRIVER_HMD_IN_USE", static_cast<int32_t>(vr::EVRInitError::VRInitError_Driver_HmdInUse)},
	  {"INIT_ERROR_DRIVER_NOT_CALIBRATED", static_cast<int32_t>(vr::EVRInitError::VRInitError_Driver_NotCalibrated)}, {"INIT_ERROR_DRIVER_CALIBRATION_INVALID", static_cast<int32_t>(vr::EVRInitError::VRInitError_Driver_CalibrationInvalid)},
	  {"INIT_ERROR_DRIVER_HMD_DISPLAY_NOT_FOUND", static_cast<int32_t>(vr::EVRInitError::VRInitError_Driver_HmdDisplayNotFound)},

	  {"INIT_ERROR_IPC_SERVER_INIT_FAILED", static_cast<int32_t>(vr::EVRInitError::VRInitError_IPC_ServerInitFailed)}, {"INIT_ERROR_IPC_CONNECT_FAILED", static_cast<int32_t>(vr::EVRInitError::VRInitError_IPC_ConnectFailed)},
	  {"INIT_ERROR_IPC_SHARED_STATE_INIT_FAILED", static_cast<int32_t>(vr::EVRInitError::VRInitError_IPC_SharedStateInitFailed)}, {"INIT_ERROR_IPC_COMPOSITOR_INIT_FAILED", static_cast<int32_t>(vr::EVRInitError::VRInitError_IPC_CompositorInitFailed)},
	  {"INIT_ERROR_IPC_MUTEX_INIT_FAILED", static_cast<int32_t>(vr::EVRInitError::VRInitError_IPC_MutexInitFailed)}, {"INIT_ERROR_IPC_FAILED", static_cast<int32_t>(vr::EVRInitError::VRInitError_IPC_Failed)},

	  {"INIT_ERROR_COMPOSITOR_FAILED", static_cast<int32_t>(vr::EVRInitError::VRInitError_Compositor_Failed)}, {"INIT_ERROR_COMPOSITOR_D3D11_HARDWARE_REQUIRED", static_cast<int32_t>(vr::EVRInitError::VRInitError_Compositor_D3D11HardwareRequired)},
	  ...
	  {"COMPOSITOR_ERROR_NONE", static_cast<int32_t>(vr::EVRCompositorError::VRCompositorError_None)}, {"COMPOSITOR_ERROR_REQUEST_FAILED", static_cast<int32_t>(vr::EVRCompositorError::VRCompositorError_RequestFailed)},
	  {"COMPOSITOR_ERROR_INCOMPATIBLE_VERSION", static_cast<int32_t>(vr::EVRCompositorError::VRCompositorError_IncompatibleVersion)}, {"COMPOSITOR_ERROR_DO_NOT_HAVE_FOCUS", static_cast<int32_t>(vr::EVRCompositorError::VRCompositorError_DoNotHaveFocus)},
	  {"COMPOSITOR_ERROR_INVALID_TEXTURE", static_cast<int32_t>(vr::EVRCompositorError::VRCompositorError_InvalidTexture)}, {"COMPOSITOR_ERROR_IS_NOT_SCENE_APPLICATION", static_cast<int32_t>(vr::EVRCompositorError::VRCompositorError_IsNotSceneApplication)},
	  {"COMPOSITOR_ERROR_TEXTURE_IS_ON_WRONG_DEVICE", static_cast<int32_t>(vr::EVRCompositorError::VRCompositorError_TextureIsOnWrongDevice)}, {"COMPOSITOR_ERROR_TEXTURE_USES_UNSUPPORTED_FORMAT", static_cast<int32_t>(vr::EVRCompositorError::VRCompositorError_TextureUsesUnsupportedFormat)},
	  {"COMPOSITOR_ERROR_SHARED_TEXTURES_NOT_SUPPORTED", static_cast<int32_t>(vr::EVRCompositorError::VRCompositorError_SharedTexturesNotSupported)}, {"COMPOSITOR_ERROR_INDEX_OUT_OF_RANGE", static_cast<int32_t>(vr::EVRCompositorError::VRCompositorError_IndexOutOfRange)},
	  {"COMPOSITOR_ERROR_ALREADY_SUBMITTED", static_cast<int32_t>(vr::EVRCompositorError::VRCompositorError_AlreadySubmitted)},

	  {"TRACKING_UNIVERSE_ORIGIN_SEATED", static_cast<int32_t>(vr::ETrackingUniverseOrigin::TrackingUniverseSeated)}, {"TRACKING_UNIVERSE_ORIGIN_STANDING", static_cast<int32_t>(vr::ETrackingUniverseOrigin::TrackingUniverseStanding)},
	  ...
	  {"EYE_LEFT", umath::to_integral(vr::EVREye::Eye_Left)}, {"EYE_RIGHT", umath::to_integral(vr::EVREye::Eye_Right)},

	  {"TRACKED_DEVICE_CLASS_INVALID", umath::to_integral(vr::ETrackedDeviceClass::TrackedDeviceClass_Invalid)}, {"TRACKED_DEVICE_CLASS_HMD", umath::to_integral(vr::ETrackedDeviceClass::TrackedDeviceClass_HMD)},
	  {"TRACKED_DEVICE_CLASS_CONTROLLER", umath::to_integral(vr::ETrackedDeviceClass::TrackedDeviceClass_Controller)}, {"TRACKED_DEVICE_CLASS_GENERIC_TRACKER", umath::to_integral(vr::ETrackedDeviceClass::TrackedDeviceClass_GenericTracker)},
	  {"TRACKED_DEVICE_CLASS_TRACKING_REFERENCE", umath::to_integral(vr::ETrackedDeviceClass::TrackedDeviceClass_TrackingReference)},

	  {"BUTTON_ID_SYSTEM", static_cast<int32_t>(vr::EVRButtonId::k_EButton_System)}, {"BUTTON_ID_APPLICATION_MENU", static_cast<int32_t>(vr::EVRButtonId::k_EButton_ApplicationMenu)}, {"BUTTON_ID_GRIP", static_cast<int32_t>(vr::EVRButtonId::k_EButton_Grip)},
	  {"BUTTON_ID_DPAD_LEFT", static_cast<int32_t>(vr::EVRButtonId::k_EButton_DPad_Left)}, {"BUTTON_ID_DPAD_UP", static_cast<int32_t>(vr::EVRButtonId::k_EButton_DPad_Up)}, {"BUTTON_ID_DPAD_RIGHT", static_cast<int32_t>(vr::EVRButtonId::k_EButton_DPad_Right)},
	  {"BUTTON_ID_DPAD_DOWN", static_cast<int32_t>(vr::EVRButtonId::k_EButton_DPad_Down)}, {"BUTTON_ID_A", static_cast<int32_t>(vr::EVRButtonId::k_EButton_A)}, {"BUTTON_ID_PROXIMITY_SENSOR", static_cast<int32_t>(vr::EVRButtonId::k_EButton_ProximitySensor)},
	  {"BUTTON_ID_AXIS0", static_cast<int32_t>(vr::EVRButtonId::k_EButton_Axis0)}, {"BUTTON_ID_AXIS1", static_cast<int32_t>(vr::EVRButtonId::k_EButton_Axis1)}, {"BUTTON_ID_AXIS2", static_cast<int32_t>(vr::EVRButtonId::k_EButton_Axis2)},
	  {"BUTTON_ID_AXIS3", static_cast<int32_t>(vr::EVRButtonId::k_EButton_Axis3)}, {"BUTTON_ID_AXIS4", static_cast<int32_t>(vr::EVRButtonId::k_EButton_Axis4)}, {"BUTTON_ID_STEAMVR_TOUCHPAD", static_cast<int32_t>(vr::EVRButtonId::k_EButton_SteamVR_Touchpad)},
	  {"BUTTON_ID_STEAMVR_TRIGGER", static_cast<int32_t>(vr::EVRButtonId::k_EButton_SteamVR_Trigger)}, {"BUTTON_ID_DASHBOARD_BACK", static_cast<int32_t>(vr::EVRButtonId::k_EButton_Dashboard_Back)},

	  {"CONTROLLER_AXIS_TYPE_NONE", static_cast<int32_t>(vr::EVRControllerAxisType::k_eControllerAxis_None)}, {"CONTROLLER_AXIS_TYPE_TRACK_PAD", static_cast<int32_t>(vr::EVRControllerAxisType::k_eControllerAxis_TrackPad)},
	  {"CONTROLLER_AXIS_TYPE_JOYSTICK", static_cast<int32_t>(vr::EVRControllerAxisType::k_eControllerAxis_Joystick)}, {"CONTROLLER_AXIS_TYPE_TRIGGER", static_cast<int32_t>(vr::EVRControllerAxisType::k_eControllerAxis_Trigger)},

	  {"MAX_TRACKED_DEVICE_COUNT", vr::k_unMaxTrackedDeviceCount},

	  {"EVENT_NONE", vr::VREvent_None}, {"EVENT_TRACKED_DEVICE_ACTIVATED", vr::VREvent_TrackedDeviceActivated}, {"EVENT_TRACKED_DEVICE_DEACTIVATED", vr::VREvent_TrackedDeviceDeactivated}, {"EVENT_TRACKED_DEVICE_UPDATED", vr::VREvent_TrackedDeviceUpdated},
	  {"EVENT_TRACKED_DEVICE_USER_INTERACTION_STARTED", vr::VREvent_TrackedDeviceUserInteractionStarted}, {"EVENT_TRACKED_DEVICE_USER_INTERACTION_ENDED", vr::VREvent_TrackedDeviceUserInteractionEnded}, {"EVENT_IPD_CHANGED", vr::VREvent_IpdChanged},
	  {"EVENT_ENTER_STANDBY_MODE", vr::VREvent_EnterStandbyMode}, {"EVENT_LEAVE_STANDBY_MODE", vr::VREvent_LeaveStandbyMode}, {"EVENT_TRACKED_DEVICE_ROLE_CHANGED", vr::VREvent_TrackedDeviceRoleChanged}, {"EVENT_WATCHDOG_WAKE_UP_REQUESTED", vr::VREvent_WatchdogWakeUpRequested},
	  {"EVENT_LENS_DISTORTION_CHANGED", vr::VREvent_LensDistortionChanged}, {"EVENT_PROPERTY_CHANGED", vr::VREvent_PropertyChanged}, {"EVENT_WIRELESS_DISCONNECT", vr::VREvent_WirelessDisconnect}, {"EVENT_WIRELESS_RECONNECT", vr::VREvent_WirelessReconnect},
	  {"EVENT_BUTTON_PRESS", vr::VREvent_ButtonPress}, {"EVENT_BUTTON_UNPRESS", vr::VREvent_ButtonUnpress}, {"EVENT_BUTTON_TOUCH", vr::VREvent_ButtonTouch}, {"EVENT_BUTTON_UNTOUCH", vr::VREvent_ButtonUntouch}, {"EVENT_MODAL_CANCEL", vr::VREvent_Modal_Cancel},
	  {"EVENT_MOUSE_MOVE", vr::VREvent_MouseMove}, {"EVENT_MOUSE_BUTTON_DOWN", vr::VREvent_MouseButtonDown}, {"EVENT_MOUSE_BUTTON_UP", vr::VREvent_MouseButtonUp}, {"EVENT_FOCUS_ENTER", vr::VREvent_FocusEnter}, {"EVENT_FOCUS_LEAVE", vr::VREvent_FocusLeave},
	  {"EVENT_SCROLL_DISCRETE", vr::VREvent_ScrollDiscrete}, {"EVENT_TOUCH_PAD_MOVE", vr::VREvent_TouchPadMove}, {"EVENT_OVERLAY_FOCUS_CHANGED", vr::VREvent_OverlayFocusChanged}, {"EVENT_RELOAD_OVERLAYS", vr::VREvent_ReloadOverlays}, {"EVENT_SCROLL_SMOOTH", vr::VREvent_ScrollSmooth},
	  {"EVENT_LOCK_MOUSE_POSITION", vr::VREvent_LockMousePosition}, {"EVENT_UNLOCK_MOUSE_POSITION", vr::VREvent_UnlockMousePosition}, {"EVENT_INPUT_FOCUS_CAPTURED", vr::VREvent_InputFocusCaptured}, {"EVENT_INPUT_FOCUS_RELEASED", vr::VREvent_InputFocusReleased},
	  {"EVENT_SCENE_APPLICATION_CHANGED", vr::VREvent_SceneApplicationChanged}, {"EVENT_SCENE_FOCUS_CHANGED", vr::VREvent_SceneFocusChanged}, {"EVENT_INPUT_FOCUS_CHANGED", vr::VREvent_InputFocusChanged},
	  {"EVENT_SCENE_APPLICATION_USING_WRONG_GRAPHICS_ADAPTER", vr::VREvent_SceneApplicationUsingWrongGraphicsAdapter}, {"EVENT_ACTION_BINDING_RELOADED", vr::VREvent_ActionBindingReloaded}, {"EVENT_HIDE_RENDER_MODELS", vr::VREvent_HideRenderModels},
	  {"EVENT_SHOW_RENDER_MODELS", vr::VREvent_ShowRenderModels}, {"EVENT_SCENE_APPLICATION_STATE_CHANGED", vr::VREvent_SceneApplicationStateChanged}, {"EVENT_CONSOLE_OPENED", vr::VREvent_ConsoleOpened}, {"EVENT_CONSOLE_CLOSED", vr::VREvent_ConsoleClosed},
	  {"EVENT_OVERLAY_SHOWN", vr::VREvent_OverlayShown}, {"EVENT_OVERLAY_HIDDEN", vr::VREvent_OverlayHidden}, {"EVENT_DASHBOARD_ACTIVATED", vr::VREvent_DashboardActivated}, {"EVENT_DASHBOARD_DEACTIVATED", vr::VREvent_DashboardDeactivated},
	  {"EVENT_DASHBOARD_REQUESTED", vr::VREvent_DashboardRequested}, {"EVENT_RESET_DASHBOARD", vr::VREvent_ResetDashboard}, {"EVENT_IMAGE_LOADED", vr::VREvent_ImageLoaded}, {"EVENT_SHOW_KEYBOARD", vr::VREvent_ShowKeyboard}, {"EVENT_HIDE_KEYBOARD", vr::VREvent_HideKeyboard},
	  {"EVENT_OVERLAY_GAMEPAD_FOCUS_GAINED", vr::VREvent_OverlayGamepadFocusGained}, {"EVENT_OVERLAY_GAMEPAD_FOCUS_LOST", vr::VREvent_OverlayGamepadFocusLost}, {"EVENT_OVERLAY_SHARED_TEXTURE_CHANGED", vr::VREvent_OverlaySharedTextureChanged},
	  {"EVENT_SCREENSHOT_TRIGGERED", vr::VREvent_ScreenshotTriggered}, {"EVENT_IMAGE_FAILED", vr::VREvent_ImageFailed}, {"EVENT_DASHBOARD_OVERLAY_CREATED", vr::VREvent_DashboardOverlayCreated}, {"EVENT_SWITCH_GAMEPAD_FOCUS", vr::VREvent_SwitchGamepadFocus},
	  {"EVENT_REQUEST_SCREENSHOT", vr::VREvent_RequestScreenshot}, {"EVENT_SCREENSHOT_TAKEN", vr::VREvent_ScreenshotTaken}, {"EVENT_SCREENSHOT_FAILED", vr::VREvent_ScreenshotFailed}, {"EVENT_SUBMIT_SCREENSHOT_TO_DASHBOARD", vr::VREvent_SubmitScreenshotToDashboard},
	  {"EVENT_SCREENSHOT_PROGRESS_TO_DASHBOARD", vr::VREvent_ScreenshotProgressToDashboard}, {"EVENT_PRIMARY_DASHBOARD_DEVICE_CHANGED", vr::VREvent_PrimaryDashboardDeviceChanged}, {"EVENT_ROOM_VIEW_SHOWN", vr::VREvent_RoomViewShown}, {"EVENT_ROOM_VIEW_HIDDEN", vr::VREvent_RoomViewHidden},
	  {"EVENT_SHOW_UI", vr::VREvent_ShowUI}, {"EVENT_SHOW_DEV_TOOLS", vr::VREvent_ShowDevTools}, {"EVENT_DESKTOP_VIEW_UPDATING", vr::VREvent_DesktopViewUpdating}, {"EVENT_DESKTOP_VIEW_READY", vr::VREvent_DesktopViewReady}, {"EVENT_NOTIFICATION_SHOWN", vr::VREvent_Notification_Shown},
	  {"EVENT_NOTIFICATION_HIDDEN", vr::VREvent_Notification_Hidden}, {"EVENT_NOTIFICATION_BEGIN_INTERACTION", vr::VREvent_Notification_BeginInteraction}, {"EVENT_NOTIFICATION_DESTROYED", vr::VREvent_Notification_Destroyed}, {"EVENT_QUIT", vr::VREvent_Quit},
	  {"EVENT_PROCESS_QUIT", vr::VREvent_ProcessQuit}, {"EVENT_QUIT_ACKNOWLEDGED", vr::VREvent_QuitAcknowledged}, {"EVENT_DRIVER_REQUESTED_QUIT", vr::VREvent_DriverRequestedQuit}, {"EVENT_RESTART_REQUESTED", vr::VREvent_RestartRequested},
	  {"EVENT_CHAPERONE_DATA_HAS_CHANGED", vr::VREvent_ChaperoneDataHasChanged}, {"EVENT_CHAPERONE_UNIVERSE_HAS_CHANGED", vr::VREvent_ChaperoneUniverseHasChanged}, {"EVENT_CHAPERONE_TEMP_DATA_HAS_CHANGED", vr::VREvent_ChaperoneTempDataHasChanged},
	  {"EVENT_CHAPERONE_SETTINGS_HAVE_CHANGED", vr::VREvent_ChaperoneSettingsHaveChanged}, {"EVENT_SEATED_ZERO_POSE_RESET", vr::VREvent_SeatedZeroPoseReset}, {"EVENT_CHAPERONE_FLUSH_CACHE", vr::VREvent_ChaperoneFlushCache},
	  {"EVENT_CHAPERONE_ROOM_SETUP_STARTING", vr::VREvent_ChaperoneRoomSetupStarting}, {"EVENT_CHAPERONE_ROOM_SETUP_FINISHED", vr::VREvent_ChaperoneRoomSetupFinished}, {"EVENT_STANDING_ZERO_POSE_RESET", vr::VREvent_StandingZeroPoseReset},
	  {"EVENT_AUDIO_SETTINGS_HAVE_CHANGED", vr::VREvent_AudioSettingsHaveChanged}, {"EVENT_BACKGROUND_SETTING_HAS_CHANGED", vr::VREvent_BackgroundSettingHasChanged}, {"EVENT_CAMERA_SETTINGS_HAVE_CHANGED", vr::VREvent_CameraSettingsHaveChanged},
	  {"EVENT_REPROJECTION_SETTING_HAS_CHANGED", vr::VREvent_ReprojectionSettingHasChanged}, {"EVENT_MODEL_SKIN_SETTINGS_HAVE_CHANGED", vr::VREvent_ModelSkinSettingsHaveChanged}, {"EVENT_ENVIRONMENT_SETTINGS_HAVE_CHANGED", vr::VREvent_EnvironmentSettingsHaveChanged},
	  {"EVENT_POWER_SETTINGS_HAVE_CHANGED", vr::VREvent_PowerSettingsHaveChanged}, {"EVENT_ENABLE_HOME_APP_SETTINGS_HAVE_CHANGED", vr::VREvent_EnableHomeAppSettingsHaveChanged}, {"EVENT_STEAM_VR_SECTION_SETTING_CHANGED", vr::VREvent_SteamVRSectionSettingChanged},
	  {"EVENT_LIGHTHOUSE_SECTION_SETTING_CHANGED", vr::VREvent_LighthouseSectionSettingChanged}, {"EVENT_NULL_SECTION_SETTING_CHANGED", vr::VREvent_NullSectionSettingChanged}, {"EVENT_USER_INTERFACE_SECTION_SETTING_CHANGED", vr::VREvent_UserInterfaceSectionSettingChanged},
	  {"EVENT_NOTIFICATIONS_SECTION_SETTING_CHANGED", vr::VREvent_NotificationsSectionSettingChanged}, {"EVENT_KEYBOARD_SECTION_SETTING_CHANGED", vr::VREvent_KeyboardSectionSettingChanged}, {"EVENT_PERF_SECTION_SETTING_CHANGED", vr::VREvent_PerfSectionSettingChanged},
	  {"EVENT_DASHBOARD_SECTION_SETTING_CHANGED", vr::VREvent_DashboardSectionSettingChanged}, {"EVENT_WEB_INTERFACE_SECTION_SETTING_CHANGED", vr::VREvent_WebInterfaceSectionSettingChanged}, {"EVENT_TRACKERS_SECTION_SETTING_CHANGED", vr::VREvent_TrackersSectionSettingChanged},
	  {"EVENT_LAST_KNOWN_SECTION_SETTING_CHANGED", vr::VREvent_LastKnownSectionSettingChanged}, {"EVENT_DISMISSED_WARNINGS_SECTION_SETTING_CHANGED", vr::VREvent_DismissedWarningsSectionSettingChanged}, {"EVENT_GPU_SPEED_SECTION_SETTING_CHANGED", vr::VREvent_GpuSpeedSectionSettingChanged},
	  {"EVENT_WINDOWS_MR_SECTION_SETTING_CHANGED", vr::VREvent_WindowsMRSectionSettingChanged}, {"EVENT_OTHER_SECTION_SETTING_CHANGED", vr::VREvent_OtherSectionSettingChanged}, {"EVENT_STATUS_UPDATE", vr::VREvent_StatusUpdate},
	  {"EVENT_WEB_INTERFACE_INSTALL_DRIVER_COMPLETED", vr::VREvent_WebInterface_InstallDriverCompleted}, {"EVENT_MC_IMAGE_UPDATED", vr::VREvent_MCImageUpdated}, {"EVENT_FIRMWARE_UPDATE_STARTED", vr::VREvent_FirmwareUpdateStarted},
	  {"EVENT_FIRMWARE_UPDATE_FINISHED", vr::VREvent_FirmwareUpdateFinished}, {"EVENT_KEYBOARD_CLOSED", vr::VREvent_KeyboardClosed}, {"EVENT_KEYBOARD_CHAR_INPUT", vr::VREvent_KeyboardCharInput}, {"EVENT_KEYBOARD_DONE", vr::VREvent_KeyboardDone},
	  {"EVENT_APPLICATION_LIST_UPDATED", vr::VREvent_ApplicationListUpdated}, {"EVENT_APPLICATION_MIME_TYPE_LOAD", vr::VREvent_ApplicationMimeTypeLoad}, {"EVENT_PROCESS_CONNECTED", vr::VREvent_ProcessConnected}, {"EVENT_PROCESS_DISCONNECTED", vr::VREvent_ProcessDisconnected},
	  {"EVENT_COMPOSITOR_CHAPERONE_BOUNDS_SHOWN", vr::VREvent_Compositor_ChaperoneBoundsShown}, {"EVENT_COMPOSITOR_CHAPERONE_BOUNDS_HIDDEN", vr::VREvent_Compositor_ChaperoneBoundsHidden}, {"EVENT_COMPOSITOR_DISPLAY_DISCONNECTED", vr::VREvent_Compositor_DisplayDisconnected},
	  {"EVENT_COMPOSITOR_DISPLAY_RECONNECTED", vr::VREvent_Compositor_DisplayReconnected}, {"EVENT_COMPOSITOR_HDCP_ERROR", vr::VREvent_Compositor_HDCPError}, {"EVENT_COMPOSITOR_APPLICATION_NOT_RESPONDING", vr::VREvent_Compositor_ApplicationNotResponding},
	  {"EVENT_COMPOSITOR_APPLICATION_RESUMED", vr::VREvent_Compositor_ApplicationResumed}, {"EVENT_COMPOSITOR_OUT_OF_VIDEO_MEMORY", vr::VREvent_Compositor_OutOfVideoMemory}, {"EVENT_COMPOSITOR_DISPLAY_MODE_NOT_SUPPORTED", vr::VREvent_Compositor_DisplayModeNotSupported},
	  {"EVENT_COMPOSITOR_STAGE_OVERRIDE_READY", vr::VREvent_Compositor_StageOverrideReady}, {"EVENT_TRACKED_CAMERA_START_VIDEO_STREAM", vr::VREvent_TrackedCamera_StartVideoStream}, {"EVENT_TRACKED_CAMERA_STOP_VIDEO_STREAM", vr::VREvent_TrackedCamera_StopVideoStream},
	  {"EVENT_TRACKED_CAMERA_PAUSE_VIDEO_STREAM", vr::VREvent_TrackedCamera_PauseVideoStream}, {"EVENT_TRACKED_CAMERA_RESUME_VIDEO_STREAM", vr::VREvent_TrackedCamera_ResumeVideoStream}, {"EVENT_TRACKED_CAMERA_EDITING_SURFACE", vr::VREvent_TrackedCamera_EditingSurface},
	  {"EVENT_PERFORMANCE_TEST_ENABLE_CAPTURE", vr::VREvent_PerformanceTest_EnableCapture}, {"EVENT_PERFORMANCE_TEST_DISABLE_CAPTURE", vr::VREvent_PerformanceTest_DisableCapture}, {"EVENT_PERFORMANCE_TEST_FIDELITY_LEVEL", vr::VREvent_PerformanceTest_FidelityLevel},
	  {"EVENT_MESSAGE_OVERLAY_CLOSED", vr::VREvent_MessageOverlay_Closed}, {"EVENT_MESSAGE_OVERLAY_CLOSE_REQUESTED", vr::VREvent_MessageOverlayCloseRequested}, {"EVENT_INPUT_HAPTIC_VIBRATION", vr::VREvent_Input_HapticVibration},
	  {"EVENT_INPUT_BINDING_LOAD_FAILED", vr::VREvent_Input_BindingLoadFailed}, {"EVENT_INPUT_BINDING_LOAD_SUCCESSFUL", vr::VREvent_Input_BindingLoadSuccessful}, {"EVENT_INPUT_ACTION_MANIFEST_RELOADED", vr::VREvent_Input_ActionManifestReloaded},
	  {"EVENT_INPUT_ACTION_MANIFEST_LOAD_FAILED", vr::VREvent_Input_ActionManifestLoadFailed}, {"EVENT_INPUT_PROGRESS_UPDATE", vr::VREvent_Input_ProgressUpdate}, {"EVENT_INPUT_TRACKER_ACTIVATED", vr::VREvent_Input_TrackerActivated},
	  {"EVENT_INPUT_BINDINGS_UPDATED", vr::VREvent_Input_BindingsUpdated}, {"EVENT_INPUT_BINDING_SUBSCRIPTION_CHANGED", vr::VREvent_Input_BindingSubscriptionChanged}, {"EVENT_SPATIAL_ANCHORS_POSE_UPDATED", vr::VREvent_SpatialAnchors_PoseUpdated},
	  {"EVENT_SPATIAL_ANCHORS_DESCRIPTOR_UPDATED", vr::VREvent_SpatialAnchors_DescriptorUpdated}, {"EVENT_SPATIAL_ANCHORS_REQUEST_POSE_UPDATE", vr::VREvent_SpatialAnchors_RequestPoseUpdate},
	  {"EVENT_SPATIAL_ANCHORS_REQUEST_DESCRIPTOR_UPDATE", vr::VREvent_SpatialAnchors_RequestDescriptorUpdate}, {"EVENT_SYSTEM_REPORT_STARTED", vr::VREvent_SystemReport_Started}, {"EVENT_MONITOR_SHOW_HEADSET_VIEW", vr::VREvent_Monitor_ShowHeadsetView},
